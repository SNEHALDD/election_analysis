...
os.chdir("/Users/snehalborhade/Desktop/UT_Austin_BootCamp/Challenges/Challenge_3/election_analysis")
...
with open(file_to_save, "w") as txt_file:
    ...
    for c in county_votes:
        ...
        votes = county_votes[c]
        # 6c: Calculate the percentage of votes for the county.
        county_percentage = float(votes)/ float(total_votes) * 100

         # 6d: Print the county results to the terminal.
        print(f"{c}: {county_percentage:.1f}%  ({votes})\n")
     
         # 6e: Save the county votes to a text file.
        txt_file.write(f"{c}: {county_percentage:.1f}%  ({votes})\n\n")
